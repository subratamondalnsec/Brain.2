    ...
    return (
        <div className="flex-1 w-full h-full flex flex-col relative z-20 overflow-hidden text-white bg-transparent">
            ...
            {/* Header */}
                        ...
                        <div className={`absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[240px] h-[240px] flex items-center justify-center select-none pointer-events-none transition-all duration-700 ease-in-out ${showTranscript ? 'opacity-10 scale-50 translate-y-24' : (isListening ? 'opacity-100 scale-100' : 'opacity-30 scale-90 grayscale')}`}>
                            {/* Deep ambient base */}
